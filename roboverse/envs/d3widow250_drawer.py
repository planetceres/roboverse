from roboverse.envs.d3widow250 import D3Widow250Env
import roboverse
...
class D3Widow250DrawerEnv(D3Widow250Env):
    ...
    def __init__(self,
        ...
        super(D3Widow250DrawerEnv, self).__init__(
    ...
    def get_info(self):
        info = super(D3Widow250DrawerEnv, self).get_info()
    ...
    def get_reward(self, info):
        ...
        if self.reward_type == "opening":
            ...
            return super(D3Widow250DrawerEnv, self).get_reward(info)


class D3Widow250DrawerRandomizedEnv(D3Widow250DrawerEnv):

    def __init__(self, **kwargs):
        drawer_pos, drawer_quat, left_opening = \
            self.set_drawer_pos_and_quat()
        super(D3Widow250DrawerRandomizedEnv, self).__init__(
    ...
    def reset(self):
        ...
        return super(D3Widow250DrawerRandomizedEnv, self).reset()


class D3Widow250DoubleDrawerEnv(D3Widow250DrawerEnv):
    def __init__(self,
                 drawer_pos=(0.5, 0.2, -.35),
                 drawer_quat=(0, 0, 0.707107, 0.707107),
                 left_opening=True,  # False is not supported
        ...
        super(D3Widow250DoubleDrawerEnv, self).__init__(
            drawer_pos=drawer_pos,
            drawer_quat=drawer_quat,
    ...
    def _load_meshes(self):
        super(D3Widow250DoubleDrawerEnv, self)._load_meshes()
    ...
    def get_info(self):
        info = super(D3Widow250DoubleDrawerEnv, self).get_info()
...
if __name__ == "__main__":
    env = roboverse.make('D3Widow250DoubleDrawerCloseOpenNeutral-v0',
