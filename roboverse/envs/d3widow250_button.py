...
class D3Widow250ButtonEnv(D3Widow250Env):
    ...
    def __init__(self,
        ...
        super(D3Widow250ButtonEnv, self).__init__(
    ...
    def _load_meshes(self):
        super(D3Widow250ButtonEnv, self)._load_meshes()
    ...
    def get_info(self):
        info = super(D3Widow250ButtonEnv, self).get_info()
...
if __name__ == "__main__":
    env = roboverse.make("D3Widow250RandPosButtonPressTwoObjGrasp-v0",
