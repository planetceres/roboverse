...
class D3Widow250PickPlaceEnv(D3Widow250Env):
    ...
    def __init__(self,
        ...
        super(D3Widow250PickPlaceEnv, self).__init__(**kwargs)
    ...
    def reset(self):
        super(D3Widow250PickPlaceEnv, self).reset()
    ...
    def get_info(self):
        info = super(D3Widow250PickPlaceEnv, self).get_info()
...
class D3Widow250PickPlaceMultiObjectEnv(MultiObjectEnv, D3Widow250PickPlaceEnv):
    """Grasping Env but with a random object each time."""


class D3Widow250PickPlaceMultiObjectMultiContainerEnv(
    MultiObjectMultiContainerEnv, D3Widow250PickPlaceEnv):
    """Grasping Env but with a random object each time."""
